        ...
        <div class="row m-0 p-0">
            <div class="col m-0 p-0">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    <a href="index.php" class="navbar-brand mx-sm-auto m-md-0"><img src="IMG/Logo.png" class=""
                                                                                    style="width:7em; height: 5em"></a>
                    ...
                    <h1 class="text-center text-danger font-italic w-100">Cruz del norte</h1>
                    <!-- aca es donde se llama al menu -->
                    <div class="collapse navbar-collapse" id="uno">
                        <h3 class="text-danger">Nombre de usuario</h3>
                        <a href="login.php"><button type="button" class="btn btn-primary">Cerrar sesión</button></a>
                        <div>
                </nav>
</header>